...
*/
    ...
    if (Serial.available() > 0) {
        lastKey = Serial.read();
        /*switch(lastKey){
           case 'w': digitalWrite(SK_UP_BUTTON,LOW);break;
           case 's': digitalWrite(SK_DOWN_BUTTON,LOW);break;
           case 'a': digitalWrite(SK_LEFT_BUTTON,LOW);break;
           case 'd': digitalWrite(SK_RIGHT_BUTTON,LOW);break;
           case 'n': digitalWrite(SK_A_BUTTON,LOW);break;
           case 'm': digitalWrite(SK_B_BUTTON,LOW);break;
        }*/
